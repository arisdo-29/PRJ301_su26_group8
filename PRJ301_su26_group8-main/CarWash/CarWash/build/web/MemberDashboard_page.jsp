...
<%
    ...
    LoyaltyAccount account =
            (LoyaltyAccount) request.getAttribute("account");

    String tierName =
            (account != null) ? account.getTierName() : "Bronze";

    int points =
            (account != null) ? account.getPoints() : 0;

    int totalWash =
            (account != null) ? account.getTotalWashes() : 0;
...
<div class="container">
    ...
    <div class="welcome">
        ...
        <span class="tier-badge <%= tierCss %>">
            <%= tierName %>
        </span>
    </div>

    <p class="sub">
        Chào mừng bạn quay lại AutoWash Pro ✨
    </p>
    ...
    <div class="cards">
        ...
        <div class="card">
            <div class="card-icon">📱</div>
            <div class="card-label">Số điện thoại</div>
            <div class="card-value" style="font-size:18px;">
                <%= currentUser.getPhoneNumber() == null || currentUser.getPhoneNumber().trim().isEmpty()
                        ? "Chưa cập nhật"
    ...
    <div class="actions">
        ...
        <a href="getcars" class="btn btn-primary">
            🚗 Xe của tôi
        </a>

        <a href="my-points" class="btn btn-outline">
            ⭐ Điểm thưởng
        </a>
